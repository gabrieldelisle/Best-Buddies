...
f1 = open('f1_filters_dict.pckl', 'rb')
filters_dict = pickle.load(f1)
f1.close()

'''


# Stiching filters on a black picture
...
def stich_filters(kept_filters, layer_name):
    # By default, we want to visualize 9 (n*n) filters on a 3 x 3 grid.
    n = 3
...
#    save_img('stitched_filters_{}.png'.format(layer_name), stitched_filters)
    save_img('not_sorted_stitched_filters_{}.png'.format(layer_name), stitched_filters)
